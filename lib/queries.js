...
// ──────────────────────────────────────────────────────────────────
//
// Last 30 days of decile×market_type×bet_side buckets, ordered by
// day descending so the JSX heatmap reads "newest first"
// left-to-right.
//
// Migration 027 (2026-05-04): switched from mv_calibration_buckets
// to mv_calibration_buckets_win.  The new MV buckets trades by
// predicted probability of THE TRADE WINNING (which differs by
// bet_side) rather than predicted probability of YES winning (which
// is what our_prob_cal carries).  This produces a correct
// reliability diagram: a NO bet at our_prob_cal=0.04 represents the
// model saying "96% confident NO wins" — it should land in the top
// decile of the reliability diagram, not the bottom.
